...
public interface IFeature {
    ...
    /**
     * Called when the Rocket.Chat plugin's onEnable method is called, is a <strong>sync</strong>.
     * This is called when the connection is still open, <strong>if</strong> one was successfully made.
     * 
     * @param plugin a {@link Plugin} instance
     * @return whether this method ran successfully or not
     */
    ...
    /**
     * Called <strong>after</strong> a connection to Rocket.Chat is <strong>successfully</strong> made.
     * 
     * @param plugin a {@link Plugin} instance
     * @return whether this method ran successfully or not
     */
    ...
    /**
     * Called <strong>after</strong> a connection to Rocket.Chat was tried and was <strong>failed</strong>.
     * 
     * @param plugin a {@link Plugin} instance
     * @return whether this method ran successfully or not
     */
